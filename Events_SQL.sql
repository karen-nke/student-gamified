...
CREATE TABLE `soft_skills` (
  ...
  `c1_description` text NOT NULL,
  `question_1` text NOT NULL,
  `option_1_A` varchar(255) NOT NULL,
  `option_1_B` varchar(255) NOT NULL,
  `option_1_C` varchar(255) NOT NULL,
  `option_1_D` varchar(255) NOT NULL,
  `correct_answer_1` varchar(1) NOT NULL,
  `question_2` text NOT NULL,
  `option_2_A` varchar(255) NOT NULL,
  `option_2_B` varchar(255) NOT NULL,
  `option_2_C` varchar(255) NOT NULL,
  `option_2_D` varchar(255) NOT NULL,
  `correct_answer_2` varchar(1) NOT NULL,
  `question_3` text NOT NULL,
  `option_3_A` varchar(255) NOT NULL,
  `option_3_B` varchar(255) NOT NULL,
  `option_3_C` varchar(255) NOT NULL,
  `option_3_D` varchar(255) NOT NULL,
  `correct_answer_3` varchar(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
